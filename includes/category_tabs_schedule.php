    ...
    <table class="category-table">
      ...
      <tbody>
        <?php foreach ($games as $index => $game): ?>
          <?php if (isset($game['id'])): // << --- THIS IS THE FIX --- >> ?>
            <tr id="game-row-<?= $game['id'] ?>">
              ...
              <td class="match-cell">
                <div class="match-grid">
                  ...
                  <div class="team-result <?= $game['winnerteam_id'] && ($game['game_status'] === 'Final' || !$game['game_status']) ? ($game['hometeam_id'] == $game['winnerteam_id'] ? 'win' : 'loss') : '' ?>">
                    <?php if ($game['winnerteam_id'] && ($game['game_status'] === 'Final' || !$game['game_status'])): ?>
                  ...
                  <div class="team-result <?= $game['winnerteam_id'] && ($game['game_status'] === 'Final' || !$game['game_status']) ? ($game['awayteam_id'] == $game['winnerteam_id'] ? 'win' : 'loss') : '' ?>">
                    <?php if ($game['winnerteam_id'] && ($game['game_status'] === 'Final' || !$game['game_status'])): ?>
              ...
              <td>
                <?php
                if ($game['game_status'] === 'Final' || $game['winnerteam_id']) {
                    echo 'Final';
                } else {
                    echo 'Pending';
                }
          ...
          <?php endif; // << --- END OF THE FIX --- >> ?>
        <?php endforeach; ?>
      </tbody>
    </table>
  <?php else: ?>
    <p>No games found for this category. Please generate a schedule after locking seedings.</p>
  <?php endif; ?>
</div>